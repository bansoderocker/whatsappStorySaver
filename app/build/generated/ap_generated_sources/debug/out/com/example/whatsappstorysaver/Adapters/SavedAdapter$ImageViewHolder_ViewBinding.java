...
public class SavedAdapter$ImageViewHolder_ViewBinding implements Unbinder {
  private SavedAdapter.ImageViewHolder target;

  @UiThread
  public SavedAdapter$ImageViewHolder_ViewBinding(SavedAdapter.ImageViewHolder target,
      View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    SavedAdapter.ImageViewHolder target = this.target;
