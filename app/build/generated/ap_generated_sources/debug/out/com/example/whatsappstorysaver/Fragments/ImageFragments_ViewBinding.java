...
public class ImageFragments_ViewBinding implements Unbinder {
  private ImageFragments target;

  @UiThread
  public ImageFragments_ViewBinding(ImageFragments target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    ImageFragments target = this.target;
